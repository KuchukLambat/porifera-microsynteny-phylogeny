...
### 2. Working with the functionality of odp
...
* **Synteny Analysis:** [`odp`](https://github.com/conchoecia/odp) (including built-in modules `DIAMOND` и `HMMER`).
* **Phylogenetics:** `MrBayes`
* **Visualization:** `R` (with the installed package `ape`).
